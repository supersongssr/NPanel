                    ...
                    <div class="col-md-12">
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption">
                                    <!-- Song -->
                                    <span class="caption-subject font-blue bold">SS SR V2 {{trans('home.subscribe_address')}} 使用教程 </span>
                                    <!-- -->
                                </div>
                            </div>
                            <div class="portlet-body">
                                <div class="mt-clipboard-container" style="padding-top:0px;">
                                    ...
                                    <!--Song  -->
                                        ...
                                        <a href="javascript:;" class="btn blue mt-clipboard" data-clipboard-action="copy" data-clipboard-target="#mt-target-2">
                                            {{trans('home.copy_subscribe_address')}}V2Ray订阅地址
                                        </a>
                                        ...
                                        <a href="javascript:;" class="btn blue mt-clipboard" data-clipboard-action="copy" data-clipboard-target="#mt-target-3">
                                            {{trans('home.copy_subscribe_address')}}IOS Kitsunebi 专用V2Ray订阅地址
                                        </a>
                                ...
                                <div class="portlet-body">
                                    <div class="tab-content">
                                        <div class="tab-pane active">
                                            <!-- -->
                                            <div class="alert alert-danger">
                                                <p> 【提示】：此处仅显示部分节点; 特权节点、VIP节点、公益节点、netflix节点等全部节点请通过订阅获取; </p>
                                            </div>
                                            <!-- -->
