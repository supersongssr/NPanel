...
assert_test('node_traffic_rxtx_mode column exists', in_array('node_traffic_rxtx_mode', $colNames));
...
$node->node_health = 1;
$node->node_traffic_rxtx_mode = 'rxtx';
...
assert_test('node_traffic_rxtx_mode read/write', $reloaded->node_traffic_rxtx_mode === 'rxtx');
